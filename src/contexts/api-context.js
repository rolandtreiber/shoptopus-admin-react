...
const APIProvider = ({children}) => {
  ...
  const shoptopusApiContext = React.useMemo(
    () => ({
      ...
      callPasswordRecoveryApi: async (params) => await post(api_url + "auth/forgot-password", params, makeHeaders()),
      callPasswordResetApi: async (params) => await post(api_url + "auth/reset-password", params, makeHeaders()),
      ...
      fetchProductAttributeOption: async (attributeId, attributeOptionId) => await get(admin_api_url + "product-attribute/" + attributeId + "/option/" + attributeOptionId, {}, makeHeaders()),
      ...
      fetchUsersForRole: async (roleId) => await get(admin_api_url + "role/"+roleId+"/users", {}, makeHeaders()),
      fetchAvailableUsersForRole: async (roleId) => await get(admin_api_url + "role/"+roleId+"/available-users", {}, makeHeaders()),
      ...
      deleteRole: async (roleId) => await del(admin_api_url + "role/"+roleId, {}, makeHeaders()),
