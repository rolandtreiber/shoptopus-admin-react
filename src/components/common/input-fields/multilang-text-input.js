...
import OptimiseRewriteButton from "../optimise-rewrite/optimise-rewrite-button";
import {InputField} from "./input-field";
import {Grid, TextField} from "@material-ui/core";
import {useFormik} from "formik";
import * as Yup from "yup";

const MultilangTextInput = ({
                              title,
                              nullable = false,
                              value = null,
                              width,
  ...
  const [aiOperationInProgress, setAiOperationInProgress] = useState(false)
  ...
  return <>
    ...
    >
      <TranslateButton
        setOperationInProgress={setAiOperationInProgress}
        text={baseText}
        targetLanguages={targetLanguages}
        translationsFetched={handleTranslationsResult}
      />
      <OptimiseRewriteButton
        setOperationInProgress={setAiOperationInProgress}
        text={baseText}
        targetLanguages={Object.keys(availableLanguages)}
        optimisedTextsFetched={handleTranslationsResult}
      />
    </Grid>}
